...
while True:
    # Varia os dados de quantidade de pedestres e veículos antes de gerar dados fictícios
    ...
    novos_tempos_de_verde = [modelo_kmeans.obter_tempo_de_verde_por_id(semaforo.dados["id_semaforo"]) for semaforo in semaforos.lista_semaforos]
    ...
    time.sleep(5)  # Aguarda 5 minutos
